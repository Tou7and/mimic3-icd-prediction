...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', nargs='?', const="50", type=str, help="50 or full")
    parser.add_argument('--maxlen', nargs='?', const=512, type=int, help="max token length")
    parser.add_argument('--batchsize', nargs='?', const=8, type=int, help="batch size on each GPU")
    parser.add_argument('--learnrate', nargs='?', const=5e-5, type=float, help="learning rate")
    parser.add_argument('--epoch', nargs='?', const=10, type=int, help="number of epoch")
